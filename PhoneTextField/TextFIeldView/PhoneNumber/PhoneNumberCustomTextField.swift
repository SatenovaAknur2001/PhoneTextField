//
//  PhoneNumberCustomTextField.swift
//  PhoneTextField
//
...
import Foundation
import SwiftUI
enum PhoneNumberTextFieldProperty {
    case phone
    case password
}

struct PhoneNumberCustomTextField: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            case .phone:
                ...
                PhoneNumberTextField(phone: $text, placeholder: $placeholder, sectionTitle: $sectionTitle)
