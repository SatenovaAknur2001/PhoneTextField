//
//  PlaceholderCustomTextField.swift
//  PhoneTextField
//
...
import SwiftUI
    ...
    enum SizePlaceholderTextFieldProperty {
        case phone
        case password
    }

    struct SizeCustomTextField: View {
        @Binding var text: String
        
        @Binding var placeholder: String
        let imageName: String
        let fieldProperty: SizePlaceholderTextFieldProperty
        ...
        var body: some View {
            VStack(alignment: .leading) {
                ...
                case .phone:
                    ...
                    SizeTextField(phone: $text, placeholder: $placeholder, sectionTitle: $sectionTitle)
                case .password:
                    Text(sectionTitle)
                        .font(.system(size: 14))
