...
import SwiftUI
enum DocumentTextFieldProperty {
    case phone
    case password
}

struct DocumentCustomTextField: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            case .phone:
                ...
                DocumentTextField(phone: $text, placeholder: $placeholder, sectionTitle: $sectionTitle)
