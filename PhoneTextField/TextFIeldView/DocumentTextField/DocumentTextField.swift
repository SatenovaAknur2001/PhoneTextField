            ...
            HStack {
                ...
                TextField(placeholder, text: $phone)
                    ...
                    .onChange(of: phone, perform: { value in
                        phone = format(with: "XXXXXXXXXXXX", phone: value)
                    })
...
struct DocumentTextField_Previews: PreviewProvider {
    static var previews: some View {
        DocumentTextField(phone: .constant(""), placeholder: .constant(""), sectionTitle: .constant(""))
    }
}
